...
},{"./modules/accordion/init-accordion":4,"./modules/form-validate/form":6,"./modules/header":13,"./modules/hero":14,"./modules/modals/init-modals":16,"./modules/programs":18,"./modules/questions":22,"./utils/ios-vh-fix":25}],3:[function(require,module,exports){
"use strict";
...
},{"../../vendor/swiper":27,"is-mobile":1}],16:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":23,"../../utils/scroll-lock":26}],18:[function(require,module,exports){
"use strict";
...
},{"./slider":20}],19:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setNewScrollbarValue = void 0;
var SCROLLBAR_SELECTOR = '#programs__scrollbar';
var LINE_SELECTOR = 'span';
var DEFAULT_LINE_VALUE = 0;

// The value that you're giving should be in percent
var setNewScrollbarValue = function setNewScrollbarValue() {
  var newValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_LINE_VALUE;
  var scrollbar = document.querySelector(SCROLLBAR_SELECTOR);
  var line = (scrollbar ? scrollbar : document).querySelector(LINE_SELECTOR);
  if (!scrollbar || !line) {
    return;
  }
  line.style.width = "".concat(newValue, "%");
};
exports.setNewScrollbarValue = setNewScrollbarValue;
...
var sliderInitHandler = function sliderInitHandler() {
  return void (0, _scrollbar.setNewScrollbarValue)();
};
var sliderChangeHandler = function sliderChangeHandler(swiper) {
  (0, _scrollbar.setNewScrollbarValue)(swiper.progress * 100);
};
...
},{"../../vendor/swiper":27,"./scrollbar":19,"is-mobile":1}],21:[function(require,module,exports){
"use strict";
...
},{"./handlers":21}],23:[function(require,module,exports){
"use strict";
